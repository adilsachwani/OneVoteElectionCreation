      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <br><h1>Create Election</h1>
            ...
            <fieldset>
              <legend>Do you really want to deploy the election?</legend>
            </fieldset><br>
            ...
            <!--   <div class="col-md-2">
              ...
              <div class="col-md-5">
                <button type="submit" class="btn btn-primary btn-lg btn-block btn btn-success" onclick="userActionCancel()">No</button>
              </div>

               <br> 
               <p id="transaction" align="centre"></p>
